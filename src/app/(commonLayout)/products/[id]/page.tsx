...
export default function ProductDetailPage() {
  ...
  if (isLoading) {
    return <div className="container mx-auto py-12 px-4 min-h-screen pt-20 animate-pulse flex flex-col md:flex-row gap-10">
  ...
  if (!product) {
    return <div className="container mx-auto py-24 text-center">
  ...
  return (
    <div className="container mx-auto py-12 px-4 min-h-screen pt-8">
      ...
      <div className="bg-card border rounded-3xl overflow-hidden shadow-lg shadow-muted flex flex-col md:flex-row">
        {/* Left: Image */}
        ...
        <div className="w-full md:w-1/2 p-8 md:p-12 flex flex-col">
           <div className="text-primary font-bold tracking-wider mb-2 uppercase text-sm">
           ...
           <div className="space-y-4 border-y py-6 mb-8">
