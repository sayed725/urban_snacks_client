...
import { Eye, Trash2, Plus, X, Minus, Download } from "lucide-react";
            ...
            <Sheet>
              ...
              <SheetContent side="right" className="w-[85vw] sm:w-[400px] p-0 flex flex-col" showCloseButton={false}>
                ...
                <div className="p-6 space-y-8 flex-1 overflow-y-auto">
                  <SheetDescription className="sr-only">Filter and sort order management table</SheetDescription>
                  ...
                  {/* Payment Status */}
                  <div className="space-y-3">
                    <h3 className="font-bold text-sm text-muted-foreground uppercase tracking-wider">Payment Status</h3>
               ...
               <div className="grid grid-cols-2 gap-4 text-sm">
                  ...
                  <div className="space-y-1">
                      ...
                      <p><span className="font-medium">Status:</span> <Badge variant="outline" className={getPaymentColor(selectedOrder.paymentStatus)}>{selectedOrder.paymentStatus}</Badge></p>
                        ...
                        <p><span className="font-medium">Discount:</span> <span className="text-red-500 font-bold">-{formatPrice(selectedOrder.discountAmount)} {selectedOrder.coupon?.code && `(${selectedOrder.coupon.code})`}</span></p>
