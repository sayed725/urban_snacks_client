            ...
            {featuredLoading ? (
               ...
               <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6 lg:gap-8">
                  {featuredItems.map((item) => (
                     <div key={item.id} className="group flex flex-col border rounded-3xl overflow-hidden shadow-sm bg-card hover:shadow-xl transition-all duration-300">
                        ...
                        <div className="p-6">
                           ...
                           <Link href={`/products/${item.id}`} className="text-xl font-bold group-hover:text-primary transition-colors line-clamp-1">{item.name}</Link>
