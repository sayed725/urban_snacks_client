                    ...
                    <motion.div
                      ...
                      className={cn(
                        ...
                        isActive
                          ...
                          : isPassed
                          ? "bg-amber-500 dark:bg-amber-800 text-white ring-1 sm:ring-2 ring-amber-200 dark:ring-amber-800"
                    ...
                    <div className="flex-1 h-[2px] sm:h-[3px] mx-1 sm:mx-2 rounded-full bg-border overflow-hidden relative  md:mt-[-28px]">
                      <motion.div
                        ...
                        className={cn(
                          ...
                          isPassed ? "from-amber-400 to-amber-500 dark:from-amber-600 dark:to-amber-800" : `${step.gradient}`
                        )}
                      />
                    </div>
                  )}
                ...
                <div className="p-6 sm:p-8 lg:p-10 flex flex-col h-full">
                  ...
                  <div className="flex items-center gap-5 mb-8">
                    ...
                    <div>
                      <span
                        className={cn(
                          "inline-block text-xs font-extrabold uppercase tracking-[0.2em] rounded-full mb-1",
                      ...
                      <h3 className="text-2xl sm:text-3xl font-semibold text-slate-600 dark:text-slate-100">
                        {current.title}
                      </h3>
                    </div>
                  </div>
              ...
              >
                ...
                <div className="relative z-10 text-white text-center p-8 sm:p-12 flex flex-col items-center">
                  ...
                  <motion.h3
                    ...
                    className="text-3xl sm:text-4xl lg:text-5xl text-slate-700 dark:text-slate-300 mb-4 tracking-tight drop-shadow"
                  >
                    {current.title}
                  </motion.h3>
                  ...
                  <motion.p
                    ...
                    className="text-base sm:text-lg font-medium text-white/90 max-w-sm leading-relaxed"
                  >
                    {current.description}
                  </motion.p>
                </div>
