  ...
  return (
    ...
    >
      ...
      >
        ...
        {product.isFeatured && (
            <Badge className="bg-amber-500/90 text-white backdrop-blur-md border-none px-2 py-1 text-[10px] font-bold tracking-wider uppercase shadow-lg shadow-amber-500/20">
